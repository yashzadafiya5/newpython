...
if (male_birthday>=21  or male_birthmonth==3) and (male_birthday<=19 or male_birthmonth==4):
    print("your zodic sign is  'aries' and your zodic symbole is 'The ram' ",male_zodic_sign)
male_zodic_sign='aries'
if (male_birthday>=20  or male_birthmonth==4) and (male_birthday<=20 or male_birthmonth==5):
    print("your zodic sign is  'Taurus' and your zodic symbole is 'The Bull' ",male_zodic_sign)
male_zodic_sign='Taurus'
if (male_birthday>=21  or male_birthmonth==5) and (male_birthday<=20 or male_birthmonth==6):
    print("your zodic sign is  'Gemini' and your zodic symbole is 'The Twins' ",male_zodic_sign)
male_zodic_sign= 'Gemini'
if (male_birthday>=21  or male_birthmonth==6) and (male_birthday<=22 or male_birthmonth==july):
    print("your zodic sign is 'Cancer' and your zodic symbole is 'The Crab' ",male_zodic_sign)
male_zodic_sign='Cancer'
if (male_birthday>=23  or male_birthmonth==7) and (male_birthday<=22 or male_birthmonth==8):
    print("your zodic sign is 'Leo' and your zodic symbole is 'The Lion' ",male_zodic_sign)
male_zodic_sign='Virgo'
if (male_birthday>=23  or male_birthmonth==8) and (male_birthday<=22 or male_birthmonth==9):
    print("your zodic sign is 'Virgo' aries and your zodic symbole is 'The Virgin ' ",male_zodic_sign)
male_zodic_sign='Libra'
if (male_birthday>=21  or male_birthmonth==9) and (male_birthday<=19 or male_birthmonth==10):
    print("your zodic sign is 'Libra' and your zodic symbole is 'The Scales' ",male_zodic_sign)
male_zodic_sign='Scorpio'
if (male_birthday>=21  or male_birthmonth==10) and (male_birthday<=19 or male_birthmonth==11):
    print("your zodic sign is 'Scorpio'  and your zodic symbole is 'The Scorpion' ",male_zodic_sign)
male_zodic_sign='Sagittarius'
if (male_birthday>=21  or male_birthmonth==11) and (male_birthday<=19 or male_birthmonth==12):
    print("your zodic sign is 'Sagittarius'  and your zodic symbole is 'The Archer' ",male_zodic_sign)
male_zodic_sign='Capricorn'
if (male_birthday>=21  or male_birthmonth==12) and (male_birthday<=19 or male_birthmonth==1):
    print("your zodic sign is 'Capricorn'  and your zodic symbole is The 'Goat' ",male_zodic_sign)
male_zodic_sign='Aquarius'
if (male_birthday>=21  or male_birthmonth==1) and (male_birthday<=19 or male_birthmonth==2):
    print("your zodic sign is 'Aquarius'  and your zodic symbole is 'The water Bearer' ",male_zodic_sign)
male_zodic_sign='Pisces'
if (male_birthday>=21  or male_birthmonth==2) and (male_birthday<=19 or male_birthmonth==3):
...
if (female_birthday>=21  or female_birthmonth==3) and (female_birthday<=19 or female_birthmonth==4):
    print("your zodic sign is  'aries' and your zodic symbole is 'The ram' ",female_zodic_sign)
female_zodic_sign='aries'
if (female_birthday>=20  or female_birthmonth==4) and (female_birthday<=20 or female_birthmonth==5):
    print("your zodic sign is  'Taurus' and your zodic symbole is 'The Bull' ",female_zodic_sign)
female_zodic_sign='Taurus'
if (female_birthday>=21  or female_birthmonth==5) and (female_birthday<=20 or female_birthmonth==6):
    print("your zodic sign is  'Gemini' and your zodic symbole is 'The Twins' ",female_zodic_sign)
female_zodic_sign= 'Gemini'
if (female_birthday>=21  or female_birthmonth==6) and (female_birthday<=22 or female_birthmonth==july):
    print("your zodic sign is 'Cancer' and your zodic symbole is 'The Crab' ",female_zodic_sign)
female_zodic_sign='Cancer'
if (female_birthday>=23  or female_birthmonth==7) and (female_birthday<=22 or female_birthmonth==8):
    print("your zodic sign is 'Leo' and your zodic symbole is 'The Lion' ",female_zodic_sign)
female_zodic_sign='Virgo'
if (female_birthday>=23  or female_birthmonth==8) and (female_birthday<=22 or female_birthmonth==9):
    print("your zodic sign is 'Virgo' aries and your zodic symbole is 'The Virgin ' ",female_zodic_sign)
female_zodic_sign='Libra'
if (female_birthday>=21  or female_birthmonth==9) and (female_birthday<=19 or female_birthmonth==10):
    print("your zodic sign is 'Libra' and your zodic symbole is 'The Scales' ",female_zodic_sign)
female_zodic_sign='Scorpio'
if (female_birthday>=21  or female_birthmonth==10) and (female_birthday<=19 or female_birthmonth==11):
    print("your zodic sign is 'Scorpio'  and your zodic symbole is 'The Scorpion' ",female_zodic_sign)
female_zodic_sign='Sagittarius'
if (female_birthday>=21  or female_birthmonth==11) and (female_birthday<=19 or female_birthmonth==12):
    print("your zodic sign is 'Sagittarius'  and your zodic symbole is 'The Archer' ",female_zodic_sign)
female_zodic_sign='Capricorn'
if (female_birthday>=21  or female_birthmonth==12) and (female_birthday<=19 or female_birthmonth==1):
    print("your zodic sign is 'Capricorn'  and your zodic symbole is The 'Goat' ",female_zodic_sign)
female_zodic_sign='Aquarius'
if (female_birthday>=21  or female_birthmonth==1) and (female_birthday<=19 or female_birthmonth==2):
    print("your zodic sign is 'Aquarius'  and your zodic symbole is 'The water Bearer' ",female_zodic_sign)
female_zodic_sign='Pisces'
if (female_birthday>=21  or female_birthmonth==2) and (female_birthday<=19 or female_birthmonth==3):
...
if male_zodic_sign=='aries' and female_zodic_sign=='aries':
    ...
    print("maybe good, but both of you need to continue to work on relationship",result)
    ...
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='aries' and female_zodic_sign=='Scorpio':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='aries' and female_zodic_sign=='Sagittarius':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='aries' and female_zodic_sign=='Capricorn':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
...
if male_zodic_sign=='Taurus' and female_zodic_sign=='aries':
    ...
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Taurus' and female_zodic_sign=='Scorpio':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Taurus' and female_zodic_sign=='Sagittarius':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Taurus' and female_zodic_sign=='Capricorn':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Gemini' and female_zodic_sign=='aries':
    ...
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Gemini' and female_zodic_sign=='Scorpio':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Gemini' and female_zodic_sign=='Sagittarius':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Gemini' and female_zodic_sign=='Capricorn':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Cancer' and female_zodic_sign=='aries':
    ...
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Cancer' and female_zodic_sign=='Scorpio':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Cancer' and female_zodic_sign=='Sagittarius':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Cancer' and female_zodic_sign=='Capricorn':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Leo' and female_zodic_sign=='aries':
    ...
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Leo' and female_zodic_sign=='Scorpio':
    result='critical'
    print("your jodi is critical")
elif male_zodic_sign=='Leo' and female_zodic_sign=='Sagittarius':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Leo' and female_zodic_sign=='Capricorn':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='virgo' and female_zodic_sign=='aries':
    ...
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='virgo' and female_zodic_sign=='Scorpio':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='virgo' and female_zodic_sign=='Sagittarius':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='virgo' and female_zodic_sign=='Capricorn':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Libra' and female_zodic_sign=='aries':
    ...
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Libra' and female_zodic_sign=='Scorpio':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Libra' and female_zodic_sign=='Sagittarius':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Libra' and female_zodic_sign=='Capricorn':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
...
if male_zodic_sign=='Scorpio' and female_zodic_sign=='aries':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Taurus':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Gimini':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='cancer':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Leo':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='virgo':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Lio':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Scorpio':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Sagittarius':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Capricorn':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Aquarius':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Scorpio' and female_zodic_sign=='Pisces':
    result='favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Sagittarius' and female_zodic_sign=='aries':
    ...
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Sagittarius' and female_zodic_sign=='Scorpio':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Sagittarius' and female_zodic_sign=='Sagittarius':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Sagittarius' and female_zodic_sign=='Capricorn':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Capricorn' and female_zodic_sign=='aries':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Taurus':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Gimini':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='cancer':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Leo':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='virgo':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Lio':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Scorpio':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Sagittarius':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Capricorn':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Aquarius':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Capricorn' and female_zodic_sign=='Pisces':
    result='favorable'
    print("shouid be an excellent love match",result)
...
if male_zodic_sign=='Aquarius' and female_zodic_sign=='aries':
    ...
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Aquarius' and female_zodic_sign=='Scorpio':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Aquarius' and female_zodic_sign=='Sagittarius':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Aquarius' and female_zodic_sign=='Capricorn':
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
...
if male_zodic_sign=='Pisces' and female_zodic_sign=='aries':
    ...
    result=' less favorable'
    print("maybe good, but both of you need to continue to work on relationship",result)
elif male_zodic_sign=='Pisces' and female_zodic_sign=='Scorpio':
    result='favorable'
    print("shouid be an excellent love match",result)
elif male_zodic_sign=='Pisces' and female_zodic_sign=='Sagittarius':
    result='critical'
    print("can be hard to make this relationship progress smothly",result)
elif male_zodic_sign=='Pisces' and female_zodic_sign=='Capricorn':
    result='favorable'
    print("shouid be an excellent love match",result)
